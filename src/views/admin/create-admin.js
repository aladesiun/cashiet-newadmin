...
const CreateAdmin = () => {
    ...
    const createAdmin = async (e) => {
        ...
        try {
            ...
            if (response.status) {
                ...
                toast.success('admmin created successfully');
                setAdmin({ email: "", password: "", username: '' });
    ...
    return ( 
        ...
        {/* Container-fluid starts*/}
        <div className="container-fluid">
            <form onSubmit={(e) => { createAdmin(e) }} enctype='multipart/form-data'>
                            ...
                            <div className="card-body">
                                <div className="digital-add needs-validation">
                                    <div className="form-group">
                                        ...
                                        <input value={admin.email} name="email" onChange={handleInputChange} className="form-control" id="validationCustom01" type="email" required />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>username</label>
                                        <input value={admin.username} name="username" onChange={handleInputChange} className="form-control" id="validationCustom01" type="text" required />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>passord</label>
                                        <input value={admin.password} name="password" onChange={handleInputChange} className="form-control" id="validationCustom01" type="text" required />
                                    </div>
                                </div>
