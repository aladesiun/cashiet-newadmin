                    ...
                    <div className="card-body">
                        <div className="digital-add needs-validation">
                            <div className="form-group">
                                ...
                                <input name="name" onChange={handleInputChange} value={editProduct.name} className="form-control" type="text" required />
                            </div>
                            <div className="form-group">
                                <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>Price</label>
                                <input name="price" onChange={handleInputChange} value={editProduct.price} className="form-control" type="number" required />
                            </div>
                            <div className="form-group">
                                ...
                                <select className="custom-select form-control" required name="category" onChange={handleInputChange} >
                                    <option value={editProduct.category}></option>
                            ...
                            <div className="form-group">
                                ...
                                <select className="custom-select form-control" required name="subCategoryOne" onChange={handleInputChange}>
                                    <option value={editProduct.subcategoryOne}></option>
                            ...
                            <div className="form-group">
                                ...
                                <select className="custom-select form-control" required name="subCategoryTwo" onChange={handleInputChange}>
                                    <option value={editProduct.subcategoryTwo}></option>
                                    {subcategory.subcategories && subcategory.subcategories.map((category) => (
                                        <option key={category._id} value={category._id}>{category.name}</option>
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="form-group">
                            ...
                            <input name="productHeight" onChange={handleInputChange} value={editProduct.height} className="form-control" type="number" required />
                        </div>
                        <div className="form-group">
                            <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>Width</label>
                            <input name="productWidth" onChange={handleInputChange} value={editProduct.width} className="form-control" type="number" required />
                        </div>
                        <div className="form-group">
                            <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>Length</label>
                            <input name="productLength" onChange={handleInputChange} value={editProduct.length} className="form-control" type="number" required />
                        </div>
                        <div className="form-group">
                            <label htmlFor="validationCustom01" className="col-form-label pt-0"><span>*</span>quantity</label>
                            <input name="quantity" onChange={handleInputChange} value={editProduct.quantity} className="form-control" type="number" required />
                        </div>
                        <div className="form-group">
