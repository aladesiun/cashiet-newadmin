        ...
        <div className="page-sidebar">
                ...
                <div className="sidebar custom-scrollbar">
                    ...
                    <ul className="sidebar-menu">
                        <li className="active">
                            <Link className="sidebar-header active" to="index">
                        ...
                        <li>
                            <Link className="sidebar-header" to="media">
                        ...
                        <li>
                            ...
                            <ul className="sidebar-submenu">
                                <li>
                                    <Link  to="translations"><i className="fa fa-circle"></i>Translations
                                    </Link>
                                </li>
                                <li>
                                    <Link  to="currency-rates"><i className="fa fa-circle"></i>Currency Rates
                                    </Link>
                                </li>
                                <li>
                                    <Link  to="taxes"><i className="fa fa-circle"></i>Taxes
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <Link className="sidebar-header" to="reports"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-bar-chart"><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></svg><span>Reports</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link className="sidebar-header" to="login">
